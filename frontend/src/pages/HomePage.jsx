 ...
 */
export function HomePage({ user, navigate, onUserChange }) {
  ...
  return (
    <div className="page-stack">
      ...
      {role === "ADMIN" && <AdminHome user={user} navigate={navigate} onUserChange={onUserChange} />}
      {role === "HEAD" && <HeadHome user={user} navigate={navigate} onUserChange={onUserChange} />}
      {(role === "LECTURER" || (!role || (role !== "ADMIN" && role !== "HEAD"))) && (
        <LecturerHome user={user} navigate={navigate} onUserChange={onUserChange} />
      )}
    </div>
  );
}
