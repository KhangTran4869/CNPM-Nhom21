...
/**
 * Giao diện Trang chủ dành riêng cho Trưởng bộ môn (HEAD)
 */
export function HeadHome({ user, navigate }) {
  return (
    <div className="grid-stack" style={{ display: "grid", gap: "20px" }}>
      <Card title="Hồ sơ Trưởng bộ môn">
        <div className="profile-grid">
          ...
          <InfoCell label="Vai trò nghiệp vụ" value={<Badge>HEAD (Trưởng bộ môn)</Badge>} />
      ...
      <Card title="Quyền hạn & Nhiệm vụ Trưởng bộ môn">
        <div style={{ padding: "8px 0", lineHeight: "1.6" }}>
          <p>👑 <strong>Quyền hạn Trưởng bộ môn:</strong></p>
          <ul style={{ paddingLeft: "20px", marginTop: "10px" }}>
            <li>Thực hiện <strong>Phân công giảng viên</strong> vào các lớp tín chỉ thuộc bộ môn mình quản lý.</li>
            <li>Tự động kiểm tra xung đột lịch giảng dạy và cảnh báo lố giờ chuẩn của giảng viên trong bộ môn.</li>
            <li>Đề xuất thay đổi phân công, quản lý danh sách giảng viên trực thuộc và xem báo cáo thống kê.</li>
          </ul>
        </div>
      </Card>
    </div>
